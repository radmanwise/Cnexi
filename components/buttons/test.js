...
import { View, Text, TouchableOpacity, StyleSheet, FlatList, Image, BackHandler, TextInput, ActivityIndicator } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity style={styles.likeButton} onPress={toggleModal}>
        <MaterialCommunityIcons name="message-reply-text-outline" size={28} color="black" />
      </TouchableOpacity>
