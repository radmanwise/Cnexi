...
const ReelIcon = ({ size = 24, color = "#000" }) => {
  return (
    <Svg width={size} height={size} style={{position: 'absolute'}} viewBox="0 0 24 24" fill="none">
      <Path d="M17 2.5L17 21.5" stroke={color} strokeWidth="1.8" strokeLinecap="round" />
      <Path d="M7 2.5L7 21.5" stroke={color} strokeWidth="1.8" strokeLinecap="round" />
      <Path d="M2 12L7 12M22 12L17 12" stroke={color} strokeWidth="1.8" strokeLinecap="round" />
      <Path d="M2.5 7L7 7M21.5 7L17 7" stroke={color} strokeWidth="1.8" strokeLinecap="round" />
      <Path
